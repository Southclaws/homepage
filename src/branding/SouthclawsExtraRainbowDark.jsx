    ...
    <svg viewBox="0 0 500 500" width="1em" height="1em" {...props}>
      <defs>
        ...
        <pattern
          ...
          width={495.73}
          height={306.24}
          patternTransform="translate(-64.81 302.66) rotate(-45)"
      ...
      <g id="extra-rainbow-dark">
        ...
        <path
          id="inner"
          className="cls-9"
          d="M250,485.84s-46.92-175.1-50.54-188.53L142.17,315l30.07-86.27L108.18,65,250,168.05,391.83,65,327.78,228.77,357.84,315l-57.3-17.73Z"
        />
        <path
          id="outline"
          className="cls-10"
          d="M250,485.84s-46.92-175.1-50.54-188.53L142.17,315l30.07-86.27L108.18,65,250,168.05,391.83,65,327.78,228.77,357.84,315l-57.3-17.73Zm0-94.29c2.57-12,36.45-117.32,36.45-117.32l40.83,12.63-14.81-57.09,28.25-97.32L250,192.61l-90.73-60.16,28.25,97.32-14.81,57.09,40.83-12.63S247.43,379.57,250,391.55Z"
        />
        <polygon
          id="eye"
          className="cls-10"
          points="295.15 228.06 250.01 258.29 204.86 228.06 295.15 228.06"
        />
      </g>
    </svg>
  );
...
export default SouthclawsExtraRainbowDark;
