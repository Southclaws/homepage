...
function SouthclawsMinimalDark(props) {
  return (
    <svg
    ...
    >
      <defs>
        <style>
          {
            '.cls-1{fill:#333;}.cls-2{fill:none;stroke:#dae1e5;stroke-width:4px;}'
          }
        </style>
      </defs>
      <title>{'southclaws-minimal-dark'}</title>
      <g id="minimal-dark">
...
export default SouthclawsMinimalDark;
